...
[![Go Reference](https://pkg.go.dev/badge/github.com/cass-dlcm/peanutbutteredsalmon.svg/v2)](https://pkg.go.dev/github.com/cass-dlcm/peanutbutteredsalmon/v3)
...
```Shell
$ go run v3/main.go [-stage ""] [-event ""] [-tide ""] [-weapon ""] [-save] [-load] [-splatnet] [-statink ""] [-salmonstats ""]
```
